...
<div class="row justify-content-center">
  ...
  <div class="col-md-10">
    ...
    <div class="text-center">
            <img src=" https://bagasarya.xyz/img/info/modelFb.png" alt="" class="img-fluid d-block mx-auto" width="120">
                <span class="Fz(15px) Fw(700) C(#000000) Mt(10px)" style="color:  !important;">@Facebook.com</span>
      ...
      <onclick="window.location='<?= $parts[1] ?>';">
        <img src="https://i.postimg.cc/Kv02fzFw/IMG-20230319-200517.jpg" alt="" class="img-fluid d-block mx-auto" width="170">
      <br>
    <br>
    <br>
    <br>    <br>
